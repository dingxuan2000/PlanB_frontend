...
public class TutorOngoingcustomListView extends ArrayAdapter<String> {
    ...
    public TutorOngoingcustomListView(Activity context, ArrayList<String> tutor_name, ArrayList<String> course_code,
                                      ArrayList<String> time, ArrayList<String> phone_number) {
        super(context, R.layout.tutor_ongoing_listview_layout, tutor_name);
