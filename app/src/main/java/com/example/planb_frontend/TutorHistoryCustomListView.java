...
public class TutorHistoryCustomListView extends ArrayAdapter<String> {
    ...
    public TutorHistoryCustomListView(Activity context, String[] names, String[] time, String[] course, Integer[] tutor_imgid){
        super(context, R.layout.tutor_history_listview_layout, names);
